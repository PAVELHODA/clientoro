      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden"
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">
            ...
            <span className="text-amber-300">Automatically.</span>
          </h2>
          <p className="text-white/70 text-lg mb-8 max-w-md">
            AI-powered booking system that helps you grow. No lost leads, no empty slots.
          </p>
          <div className="space-y-3">
            {[['📅', 'Online booking 24/7'], ['🤖', 'AI growth assistant'], ['📊', 'Revenue intelligence & KPI'], ['🏆', 'Your clients are gold']].map(([icon, text]) => (
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-400">
                ...
                <a href="/register" className="text-sky-600 hover:text-sky-800 font-semibold">Register</a>
              </p>
            </div>
          </div>
