...
export default function ThemeSelector({ onSelect }: { onSelect: (id: number) => void }) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4">
      {themes.map((theme) => (
        <button
          ...
          className="rounded shadow p-4 flex flex-col items-center justify-center hover:scale-105 transition"
