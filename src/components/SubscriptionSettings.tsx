...
const PLANS = [
  {
    ...
    limits: '50 rezervací/měs · 100 klientů · 1 osoba',
  },
  {
    slug: 'firma',
    name: 'FIRMA',
    ...
    popular: true,
    features: [
      'Vše z OSVČ (neomezeně)',
      'Správa týmu + staff kalendář',
      'Google Calendar sync',
      'Reporty per zaměstnanec',
    ],
    limits: 'Neomezené rezervace · Neomezení klienti · 5 osob',
  },
  {
    slug: 'solo_inspire',
    name: 'SOLO INSPIRE',
    desc: 'OSVČ + AI a nástroje pro růst',
    price: 499,
    priceAI: 799,
    popular: false,
    features: [
    ...
    limits: 'Neomezené · 1 osoba · 5 kampaní/měs',
  },
  {
    slug: 'pro_inspire',
    name: 'PRO INSPIRE',
    desc: 'Majitel + max 24 zaměstnanců',
    price: 1299,
    priceAI: 1999,
    popular: false,
    features: [
    ...
    limits: 'Neomezené · 25 osob · Neomezené kampaně',
  },
]
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-blue-900">
              Zkušební období — zbývá {trialDays} {trialDays === 1 ? 'den' : trialDays < 5 ? 'dny' : 'dní'}
            </p>
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-emerald-900">
              Aktivní předplatné — {PLANS.find(p => p.slug === currentPlan)?.name}{info?.plan_with_ai ? ' + AI' : ''}
            </p>
      ...
      <div className="text-center text-xs text-gray-400 space-y-1">
        ...
        <p>Předplatné můžete kdykoliv zrušit. Žádné skryté poplatky.</p>
      </div>
    </div>
  )
}
